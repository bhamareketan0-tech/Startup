...
export function ChaptersPage() {
  ...
  const [chapters, setChapters] = useState<Chapter[]>(() => getChapters((cls as "11" | "12") || "11"));

  useEffect(() => {
    fetchChaptersFromAPI((cls as "11" | "12") || "11").then(setChapters);
  }, [cls]);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-10">
            <h1 className="text-5xl font-black mb-2 uppercase tracking-tighter" style={{ color: "var(--bs-text)" }}>
              Class {cls} <span style={{ color: "var(--bs-accent-hex)" }}>Chapters</span>
            </h1>
            ...
            {chapters.map((chapter, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className="w-10 h-10 border flex items-center justify-center shrink-0 transform -skew-x-12 transition-colors"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs font-mono uppercase tracking-wide" style={{ color: "var(--bs-text-muted)" }}>
                      {chapter.subunits.length} subunits
                    </p>
                  </div>
                  <ChevronRight
