    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "transparent" }}>
      <div className="w-full max-w-md">
        ...
        <div className="border p-8" style={{ background: "var(--bs-surface)", borderColor: "var(--bs-border-subtle)" }}>
          ...
          <button type="button" onClick={() => handleGoogleSignIn()} className="mt-4 w-full flex items-center justify-center gap-3 py-3 border font-black uppercase text-sm" style={{ background: "var(--bs-surface-2)", borderColor: "var(--bs-border-subtle)", color: "var(--bs-text)" }}>
