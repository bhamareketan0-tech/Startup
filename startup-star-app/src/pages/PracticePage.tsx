...
import { getQuestionsForPractice } from "@/lib/questionsManager";
import {
  ChevronRight,
  ChevronLeft,
  Clock,
...
export function PracticePage() {
  ...
  async function fetchQuestions() {
    ...
    // 1. Admin-added questions (always included first)
    const adminQs = getQuestionsForPractice(chapterId!, decodedSubunit).filter(
    ...
    const apiQs = (!error && data) ? (data as Question[]) : [];
    setQuestions([...adminQs, ...apiQs]);
    setLoading(false);
  }
